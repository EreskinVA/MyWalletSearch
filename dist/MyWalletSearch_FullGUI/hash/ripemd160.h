...
static inline bool ripemd160_comp_hash(const uint8_t *h0, const uint8_t *h1) {
  // Use byte comparison to avoid strict-aliasing and alignment UB from casting uint8_t* to uint32_t*.
  return std::memcmp(h0, h1, 20) == 0;
}
