#!/bin/bash
# Step 1 Part 1: Запуск CPU поиска с паттерном 1PWo3JeB9 (сегменты 1-8)

set -euo pipefail

# Параметры
SEG_FILE="seg_b9_step1_part1.txt"
OUT_FILE="out_b9_step1_part1.txt"
LOG_FILE="log_b9_step1_part1.log"
PROGRESS_FILE="progress_b9_step1_part1.dat"
PATTERN="1PWo3JeB9"
BITS=71
...
echo "=== Step 1 Part 1: CPU поиск паттерна $PATTERN (сегменты 1-8) ==="
